...
<execution_context>
@D:/aditee/konmaxperience/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/aditee/konmaxperience/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
