...
Reference full template: `D:/aditee/konmaxperience/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/aditee/konmaxperience/.claude/get-shit-done/templates/state.md`.
