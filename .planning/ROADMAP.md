...
- [ ] 07-02-PLAN.md — Backend Ingredients module (CRUD, category filter, usage-safe delete) + Vendors module (CRUD, VendorPrice management) + shared unit conversion utility
- [ ] 07-03-PLAN.md — Backend Recipes module (CRUD, BOM upsert, CostCalculator with cycle guard) + Menu module (categories, items, channel modifiers) + vendor cost wiring
