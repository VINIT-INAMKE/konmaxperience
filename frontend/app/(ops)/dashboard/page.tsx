    ...
    <div className="flex gap-4 overflow-x-auto pb-2">
      {[1, 2, 3, 4, 5].map((i) => (
        <div key={i} className="shrink-0 flex flex-col items-center gap-2">
          <div className="size-16 rounded-full bg-muted animate-pulse motion-reduce:animate-none" />
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      {[1, 2].map((i) => (
        <div
          key={i}
          className="rounded-xl border p-4 space-y-2 animate-pulse motion-reduce:animate-none"
        >
    ...
    <div className="space-y-3">
      <div className="flex gap-2">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="size-10 rounded-full bg-muted animate-pulse motion-reduce:animate-none"
          />
        ))}
      </div>
      {[1, 2, 3, 4, 5].map((i) => (
        <div key={i} className="flex items-center gap-3">
          <div className="h-3 w-5 rounded bg-muted animate-pulse motion-reduce:animate-none" />
          <div className="h-3 flex-1 rounded bg-muted animate-pulse motion-reduce:animate-none" />
          <div className="h-3 w-16 rounded bg-muted animate-pulse motion-reduce:animate-none" />
        </div>
      ))}
    </div>
  );
...
function AdminDashboard() {
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="bg-[var(--status-warning)]/[0.02] dark:bg-[var(--status-warning)]/[0.03] rounded-2xl p-4 -mx-2 space-y-5">
      ...
      <section className="bg-[var(--status-info)]/[0.02] dark:bg-[var(--status-info)]/[0.03] rounded-2xl p-4 -mx-2 space-y-5">
      ...
      <section className="bg-[var(--status-good)]/[0.02] dark:bg-[var(--status-good)]/[0.03] rounded-2xl p-4 -mx-2 space-y-5">
          ...
          <div className="lg:col-span-2">
            {(lowStockLoading || hasLowStock) ? (
              <section className="space-y-3">
                {lowStockLoading ? (
                  <div className="animate-pulse motion-reduce:animate-none h-24 bg-muted/30 rounded-lg" />
                ) : (
